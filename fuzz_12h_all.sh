...
# Run all 6 production fuzz targets sequentially for 12 hours each
#
...
echo "Total estimated time: ~72 hours (3 days)"
echo "CPU cores: $JOBS"
...
for TARGET in "${TARGETS[@]}"; do
    ...
    if [ $EXIT_CODE -ne 0 ]; then
        ...
        echo "Check fuzz/artifacts/$TARGET/ for crash files"
    fi
