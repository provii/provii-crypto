...
#
# Examples:
#   ./fuzz_12h_individual.sh fuzz_sig_verify
#   ./fuzz_12h_individual.sh fuzz_commit
...
echo ""
echo "Corpus files: $(ls fuzz/corpus/$TARGET 2>/dev/null | wc -l | xargs)"
echo "Artifacts: $(ls fuzz/artifacts/$TARGET 2>/dev/null | wc -l | xargs)"
